...
cats_config = {
  ...
  "cf_push_timeout" => 600,
  "default_timeout" => 240,
  "include_apps" => false, #true
  "include_app" => false, #true
  "include_backend_compatibility" => false, #true
  "include_detect" => false, #true
  "include_docker" => false,
  "include_credhub" => true,
  "include_internet_dependent" => false, #true
  "include_persistent_app" => false,
  "include_route_services" => false,
  "include_routing" => false,
  "include_security_groups" => false, #true
  "include_services" => false, #true
  "include_ssh" => false, #true
  "include_sso" => false, #true
  "include_tasks" => false, #true
  "include_v3" => false,
